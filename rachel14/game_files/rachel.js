            ...
            },
            {
              ...
              value: function () {
                ...
                (this.shadowRoot.querySelector("#canuckle-title").textContent = 
                  "RACHEL #".concat(Ga(new Date(JSON.parse(window.localStorage.getItem(archiveDate)))) - 235)),
          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                var funFacts = [
                "<p align=center>Rachel's middle name! 🙏<br>We loved the sound of Rachel Grace together,<br>and it worked well with Rachel Grace Rogers.</p>", /*1 grace*/
                "<p align=center>Rachel's birth month! 💎<br>Rachel was born on April 30, 2008.</p>", /*2 april*/
                "<p align=left>One of Rachel's favourite things - <a href='http://www.admitmusicaltheatre.com' target='_blank'>ADMIT musical theatre</a>! 🎭<br>Rachel has been in 4 ADMIT productions: The Little Mermaid, Frozen, Seussical and Elf!</p>", /*3 admit*/
                "<p align=center>Not only is Rachel one year older 👵,<br>but she is Chelsea and Jillian's older sister! 🥰</p>", /*4 older*/
                "<p align=center>Rachel loves to read! 📚<br>Her favourite book series of all-time is<br><a href='https://thelandofstories.com' target='_blank'>Land of Stories</a> by Chris Colfer.</p>", /*5 books*/
                "<p align=center>Rachel has a great sense of humour and has the BEST laugh! 😂<br>It's infectious and fills up a room and makes everyone smile! 😊</p>", /*6 funny*/
                "<p align=center>Rachel loves to act! 🎬<br>Acting is one of Rachel's passions. She is excited to be starting<br>in the drama program at Canterbury this Fall!</p>", /*7 actor*/
                "<p align=center>Rachel is a smart cookie! 🧠<br>She's clever and curious and clearly takes after parents! 😆</p>", /*8 smart*/
                "<p align=center>Rachel loves to sing!🎤<br>She's been putting on impromptu singing performances<br>at home for as long as we can remember.</p>", /*9 sings*/
                "<p align=center>Chelsea's nickname for Rachel! 🐜<br>You'll have to ask Chelsea about this one!</p>", /*10 roach*/
                "<p align=center>Rachel loves drama! 🎭<br>The good kind. She's no drama queen.</p>", /*11 drama*/
                "<p align=center>Rachel was our first born! ☝️<br>She was also the first Rogers grandchild and made us parents!</p>", /*12 first*/
                "<p align=center>Rachel can't get enough candy! 🍬<br>She has a huge sweet tooth and loves a good treat bowl!</p>", /*13 candy*/
                "<p align=center>Rachel loves listening to music! 🎵<br>She loves nothing more than chilling in<br>her room with a good playlist!<br><br>Happy 14th Birthday Rachel!<br>We love you so much! ❤️</p>" /*14 music*/
