          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                "Hockey and Canada are synonymous with each other, and the sport remains integral to the country’s culture. Hockey sticks go back to the 1800s where sticks were hand carved from a single piece of wood.  The first commercial sticks were said to be created by the Mi’kmaq carvers in Nova Scotia and were made from birch and hornbeam trees.", /*135 stick*/
                "Alberta is home to the richest source of dinosaur fossils in the world! The town of Drumheller in the heart of the Canadian Badlands is known as the “Dinosaur Capital of the World” and boasts the world's largest dinosaur, a T-Rex standing 25m tall. Just down the road in the Red Deer River valley you'll find Dinosaur Provincial Park, a UNESCO World Heritage site where 58 unique dinosaur species have been discovered.", /*136 dinos*/
                "Canada is as tall as it is wide, creating a wide range of climate conditions. From blistering cold winters to hot muggy summers; torrential rain, blinding snowstorms, deadly tornadoes and scorching drought, Canadians experience some of the planet's most diverse weather systems. Windsor, Ontario is the thunderstorm capital of Canada and has more lightning strikes than any other major city across the country.", /*137 storm*/
                        ...
                        As(
                          (function (e) {
                            var a = e.evaluations,
                              ...
                              l = "Canuckle ".concat(Ga(new Date(JSON.parse(window.localStorage.getItem(archiveDate)))) - 235);
