          ...
          o(t, [
            {
              ...
              value: function () {
                ...
                if (window.localStorage.getItem("canuckle-language") == "fr") {
                  twitter.innerHTML = '<style>\n td\n {\n padding-top:10px; }\n </style>\n <table align="center"><tr><td><a href="https://www.twitter.com/CanuckleGame" target="_blank"><img src="images/twitter.png" width="40" height="40" alt="@CanuckleGame" title="@CanuckleGame"></a></td><td>Découvrez <a href="https://www.twitter.com/CanuckleGame" target="_blank">@CanuckleGame</a> sur Twitter!</td></tr></table>';  
                } else {
                  twitter.innerHTML = '<style>\n td\n {\n padding-top:10px; }\n </style>\n <table align="center"><tr><td><a href="https://www.twitter.com/CanuckleGame" target="_blank"><img src="images/images/twitter.png" width="40" height="40" alt="@CanuckleGame" title="@CanuckleGame"></a></td><td>Check out <a href="https://www.twitter.com/CanuckleGame" target="_blank">@CanuckleGame</a> on Twitter!</td></tr></table>';
                }
